...
namespace OSIsoft.PIDevClub.PIWebApiClient.Api
{
	...
	public interface INotificationRuleApi
	{
		...
		System.Threading.Tasks.Task<PINotificationRule> GetNotificationRulesAsync(string webId, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null);
		...
		System.Threading.Tasks.Task<ApiResponse<PINotificationRule>> GetNotificationRulesAsyncWithHttpInfo(string webId, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null);
		...
		System.Threading.Tasks.Task<PIItemsNotificationRuleSubscriber> GetNotificationRuleSubscribersAsync(string webId, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null);
		...
		System.Threading.Tasks.Task<ApiResponse<PIItemsNotificationRuleSubscriber>> GetNotificationRuleSubscribersAsyncWithHttpInfo(string webId, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null);
		...
		System.Threading.Tasks.Task<PIItemsNotificationRule> GetNotificationRulesQueryAsync(string databaseWebId = null, int? maxCount = null, string query = null, string selectedFields = null, int? startIndex = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null);
		...
		System.Threading.Tasks.Task<ApiResponse<PIItemsNotificationRule>> GetNotificationRulesQueryAsyncWithHttpInfo(string databaseWebId = null, int? maxCount = null, string query = null, string selectedFields = null, int? startIndex = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null);
	...
	public class NotificationRuleApi : INotificationRuleApi
	{
		...
		/// <param name="cancellationTokenSource">Signals to a CancellationToken that might be cancelled</param>
		/// <returns>async System.Threading.Tasks.Task<PINotificationRule></returns>
		public async System.Threading.Tasks.Task<PINotificationRule> GetNotificationRulesAsync(string webId, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null)
		{
			ApiResponse<PINotificationRule> localVarResponse = await GetNotificationRulesAsyncWithHttpInfo(webId, selectedFields, webIdType, cancellationTokenSource);
			return localVarResponse.Data;
		}
		...
		/// <param name="cancellationTokenSource">Signals to a CancellationToken that might be cancelled</param>
		/// <returns>async System.Threading.Tasks.Task<ApiResponse<PINotificationRule>></returns>
		public async System.Threading.Tasks.Task<ApiResponse<PINotificationRule>> GetNotificationRulesAsyncWithHttpInfo(string webId, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null)
		{
			// verify the required parameter 'webId' is set
			if (webId == null)
				throw new ApiException(400, "Missing required parameter 'webId'");
		...
		/// <param name="cancellationTokenSource">Signals to a CancellationToken that might be cancelled</param>
		/// <returns>async System.Threading.Tasks.Task<PIItemsNotificationRuleSubscriber></returns>
		public async System.Threading.Tasks.Task<PIItemsNotificationRuleSubscriber> GetNotificationRuleSubscribersAsync(string webId, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null)
		{
			ApiResponse<PIItemsNotificationRuleSubscriber> localVarResponse = await GetNotificationRuleSubscribersAsyncWithHttpInfo(webId, selectedFields, webIdType, cancellationTokenSource);
			return localVarResponse.Data;
		}
		...
		/// <param name="cancellationTokenSource">Signals to a CancellationToken that might be cancelled</param>
		/// <returns>async System.Threading.Tasks.Task<ApiResponse<PIItemsNotificationRuleSubscriber>></returns>
		public async System.Threading.Tasks.Task<ApiResponse<PIItemsNotificationRuleSubscriber>> GetNotificationRuleSubscribersAsyncWithHttpInfo(string webId, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null)
		{
			// verify the required parameter 'webId' is set
			if (webId == null)
				throw new ApiException(400, "Missing required parameter 'webId'");
		...
		/// <param name="cancellationTokenSource">Signals to a CancellationToken that might be cancelled</param>
		/// <returns>async System.Threading.Tasks.Task<PIItemsNotificationRule></returns>
		public async System.Threading.Tasks.Task<PIItemsNotificationRule> GetNotificationRulesQueryAsync(string databaseWebId = null, int? maxCount = null, string query = null, string selectedFields = null, int? startIndex = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null)
		{
			ApiResponse<PIItemsNotificationRule> localVarResponse = await GetNotificationRulesQueryAsyncWithHttpInfo(databaseWebId, maxCount, query, selectedFields, startIndex, webIdType, cancellationTokenSource);
			return localVarResponse.Data;
		}
		...
		/// <param name="cancellationTokenSource">Signals to a CancellationToken that might be cancelled</param>
		/// <returns>async System.Threading.Tasks.Task<ApiResponse<PIItemsNotificationRule>></returns>
		public async System.Threading.Tasks.Task<ApiResponse<PIItemsNotificationRule>> GetNotificationRulesQueryAsyncWithHttpInfo(string databaseWebId = null, int? maxCount = null, string query = null, string selectedFields = null, int? startIndex = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null)
		{
