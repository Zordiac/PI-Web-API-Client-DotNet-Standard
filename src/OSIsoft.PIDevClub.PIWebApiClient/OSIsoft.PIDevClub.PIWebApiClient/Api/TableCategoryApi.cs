...
namespace OSIsoft.PIDevClub.PIWebApiClient.Api
{
	...
	public interface ITableCategoryApi
	{
		...
		System.Threading.Tasks.Task<PITableCategory> GetByPathAsync(string path, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null);
		...
		System.Threading.Tasks.Task<ApiResponse<PITableCategory>> GetByPathAsyncWithHttpInfo(string path, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null);
		...
		/// <param name="cancellationTokenSource">Signals to a CancellationToken that might be cancelled</param>
		/// <returns>async System.Threading.Tasks.Task<PITableCategory></returns>
		System.Threading.Tasks.Task<PITableCategory> GetAsync(string webId, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null);
		...
		/// <param name="cancellationTokenSource">Signals to a CancellationToken that might be cancelled</param>
		/// <returns>async System.Threading.Tasks.Task<ApiResponse<PITableCategory>></returns>
		System.Threading.Tasks.Task<ApiResponse<PITableCategory>> GetAsyncWithHttpInfo(string webId, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null);
		...
		System.Threading.Tasks.Task<Object> UpdateAsync(string webId, PITableCategory tableCategory, CancellationTokenSource cancellationTokenSource = null);
		...
		System.Threading.Tasks.Task<ApiResponse<Object>> UpdateAsyncWithHttpInfo(string webId, PITableCategory tableCategory, CancellationTokenSource cancellationTokenSource = null);
	...
	public class TableCategoryApi : ITableCategoryApi
	{
		...
		/// <param name="cancellationTokenSource">Signals to a CancellationToken that might be cancelled</param>
		/// <returns>async System.Threading.Tasks.Task<PITableCategory></returns>
		public async System.Threading.Tasks.Task<PITableCategory> GetByPathAsync(string path, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null)
		{
			ApiResponse<PITableCategory> localVarResponse = await GetByPathAsyncWithHttpInfo(path, selectedFields, webIdType, cancellationTokenSource);
			return localVarResponse.Data;
		}
		...
		/// <param name="cancellationTokenSource">Signals to a CancellationToken that might be cancelled</param>
		/// <returns>async System.Threading.Tasks.Task<ApiResponse<PITableCategory>></returns>
		public async System.Threading.Tasks.Task<ApiResponse<PITableCategory>> GetByPathAsyncWithHttpInfo(string path, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null)
		{
			// verify the required parameter 'path' is set
			if (path == null)
				throw new ApiException(400, "Missing required parameter 'path'");
		...
		/// <param name="cancellationTokenSource">Signals to a CancellationToken that might be cancelled</param>
		/// <returns>async System.Threading.Tasks.Task<PITableCategory></returns>
		public async System.Threading.Tasks.Task<PITableCategory> GetAsync(string webId, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null)
		{
			ApiResponse<PITableCategory> localVarResponse = await GetAsyncWithHttpInfo(webId, selectedFields, webIdType, cancellationTokenSource);
			return localVarResponse.Data;
		}
		...
		/// <param name="cancellationTokenSource">Signals to a CancellationToken that might be cancelled</param>
		/// <returns>async System.Threading.Tasks.Task<ApiResponse<PITableCategory>></returns>
		public async System.Threading.Tasks.Task<ApiResponse<PITableCategory>> GetAsyncWithHttpInfo(string webId, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null)
		{
			// verify the required parameter 'webId' is set
			if (webId == null)
				throw new ApiException(400, "Missing required parameter 'webId'");
		...
		/// <param name="cancellationTokenSource">Signals to a CancellationToken that might be cancelled</param>
		/// <returns>async System.Threading.Tasks.Task<Object></returns>
		public async System.Threading.Tasks.Task<Object> UpdateAsync(string webId, PITableCategory tableCategory, CancellationTokenSource cancellationTokenSource = null)
		{
			ApiResponse<Object> localVarResponse = await UpdateAsyncWithHttpInfo(webId, tableCategory, cancellationTokenSource);
			return localVarResponse.Data;
		}
		...
		/// <param name="cancellationTokenSource">Signals to a CancellationToken that might be cancelled</param>
		/// <returns>async System.Threading.Tasks.Task<ApiResponse<Object>></returns>
		public async System.Threading.Tasks.Task<ApiResponse<Object>> UpdateAsyncWithHttpInfo(string webId, PITableCategory tableCategory, CancellationTokenSource cancellationTokenSource = null)
		{
			// verify the required parameter 'webId' is set
			if (webId == null)
				throw new ApiException(400, "Missing required parameter 'webId'");
