...
namespace OSIsoft.PIDevClub.PIWebApiClient.Api
{
	...
	public interface INotificationRuleSubscriberApi
	{
		...
		System.Threading.Tasks.Task<PINotificationRuleSubscriber> GetNotificationRuleSubscriberByPathAsync(string path, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null);
		...
		System.Threading.Tasks.Task<ApiResponse<PINotificationRuleSubscriber>> GetNotificationRuleSubscriberByPathAsyncWithHttpInfo(string path, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null);
		...
		/// <param name="cancellationTokenSource">Signals to a CancellationToken that might be cancelled</param>
		/// <returns>async System.Threading.Tasks.Task<PINotificationRuleSubscriber></returns>
		System.Threading.Tasks.Task<PINotificationRuleSubscriber> GetNotificationRuleSubscriberAsync(string webId, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null);
		...
		/// <param name="cancellationTokenSource">Signals to a CancellationToken that might be cancelled</param>
		/// <returns>async System.Threading.Tasks.Task<ApiResponse<PINotificationRuleSubscriber>></returns>
		System.Threading.Tasks.Task<ApiResponse<PINotificationRuleSubscriber>> GetNotificationRuleSubscriberAsyncWithHttpInfo(string webId, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null);
	...
	public class NotificationRuleSubscriberApi : INotificationRuleSubscriberApi
	{
		...
		/// <param name="cancellationTokenSource">Signals to a CancellationToken that might be cancelled</param>
		/// <returns>async System.Threading.Tasks.Task<PINotificationRuleSubscriber></returns>
		public async System.Threading.Tasks.Task<PINotificationRuleSubscriber> GetNotificationRuleSubscriberByPathAsync(string path, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null)
		{
			ApiResponse<PINotificationRuleSubscriber> localVarResponse = await GetNotificationRuleSubscriberByPathAsyncWithHttpInfo(path, selectedFields, webIdType, cancellationTokenSource);
			return localVarResponse.Data;
		}
		...
		/// <param name="cancellationTokenSource">Signals to a CancellationToken that might be cancelled</param>
		/// <returns>async System.Threading.Tasks.Task<ApiResponse<PINotificationRuleSubscriber>></returns>
		public async System.Threading.Tasks.Task<ApiResponse<PINotificationRuleSubscriber>> GetNotificationRuleSubscriberByPathAsyncWithHttpInfo(string path, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null)
		{
			// verify the required parameter 'path' is set
			if (path == null)
				throw new ApiException(400, "Missing required parameter 'path'");
		...
		/// <param name="cancellationTokenSource">Signals to a CancellationToken that might be cancelled</param>
		/// <returns>async System.Threading.Tasks.Task<PINotificationRuleSubscriber></returns>
		public async System.Threading.Tasks.Task<PINotificationRuleSubscriber> GetNotificationRuleSubscriberAsync(string webId, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null)
		{
			ApiResponse<PINotificationRuleSubscriber> localVarResponse = await GetNotificationRuleSubscriberAsyncWithHttpInfo(webId, selectedFields, webIdType, cancellationTokenSource);
			return localVarResponse.Data;
		}
		...
		/// <param name="cancellationTokenSource">Signals to a CancellationToken that might be cancelled</param>
		/// <returns>async System.Threading.Tasks.Task<ApiResponse<PINotificationRuleSubscriber>></returns>
		public async System.Threading.Tasks.Task<ApiResponse<PINotificationRuleSubscriber>> GetNotificationRuleSubscriberAsyncWithHttpInfo(string webId, string selectedFields = null, string webIdType = null, CancellationTokenSource cancellationTokenSource = null)
		{
			// verify the required parameter 'webId' is set
			if (webId == null)
				throw new ApiException(400, "Missing required parameter 'webId'");
